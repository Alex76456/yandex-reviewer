class Form extends Component {
	...
	get template() {
		return `<form>
		    	...
		    	</form>`.trim(); /*Надо исправить: метод trim() удаляет пробельные символы с начала и конца строки-здесь метод не потребуется.*/
	}
	/*Можно лучше: запись this._onSubmit можно упростить, передав функцию сабмита в конструктор при создании экземпляра класса*/
	set onSubmit(fn) {
		this._onSubmit = fn;
	}
	_onSubmit(evt) {
